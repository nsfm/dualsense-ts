import{j as e}from"./index-B3Vc337h.js";import{A as r,P as t,S as n,a as o,M as i}from"./ApiPage-D8x_ov17.js";import{C as s}from"./CodeBlock-C5O9LPzb.js";import"./Switch-BI-2z897.js";const d=()=>e.jsxs(r,{name:"Input<T>",description:"Abstract base class for all inputs. Provides a consistent event API, async iteration, and composability.",source:"src/input.ts",children:[e.jsx(t,{children:e.jsxs("p",{children:["Every readable value on the controller extends ",e.jsx("code",{children:"Input"}),", so buttons, axes, the touchpad, battery, and even the controller itself all share the same event interface."]})}),e.jsx(n,{children:"Properties"}),e.jsx(o,{properties:[{name:"state",type:"T",description:"The current value of this input (boolean, number, or compound type)"},{name:"active",type:"boolean",description:"True if the input is currently in an active state"},{name:"id",type:"InputId",description:"Identifier enum for this input"},{name:"threshold",type:"number",description:"Minimum change amount to trigger events (default: 0)"},{name:"deadzone",type:"number",description:"Minimum absolute value to register as active (default: 0)"}]}),e.jsx(n,{children:"Event Methods"}),e.jsx(i,{methods:[{name:"on",signature:'on(event: "change" | "press" | "release" | "input", callback): this',description:"Subscribe to events. Returns this for chaining."},{name:"once",signature:'once(event: "change" | "press" | "release", callback): this',description:"Subscribe to a single occurrence, then auto-remove."},{name:"off",signature:"off(event, callback): this",description:"Remove a listener."},{name:"removeAllListeners",signature:"removeAllListeners(event?): this",description:"Remove all listeners, optionally filtered by event type."}]}),e.jsx(n,{children:"Event Types"}),e.jsx(o,{properties:[{name:'"change"',type:"InputChangeType",description:"Fires when the input value changes (any direction)"},{name:'"press"',type:"InputChangeType",description:"Fires when the input becomes active (button down, axis moves)"},{name:'"release"',type:"InputChangeType",description:"Fires when the input becomes inactive (button up, axis returns)"},{name:'"input"',type:"InputEventType",description:"Fires on every HID report, even if the value hasn't changed"}]}),e.jsx(n,{children:"Four Ways to Read"}),e.jsx(t,{children:e.jsxs("p",{children:[e.jsx("strong",{children:"1. Synchronous read"})," - poll the current value:"]})}),e.jsx(s,{code:`if (controller.cross.active) {
