import{j as e,g as n,a as d,C,R as D,L as h}from"./index-B3Vc337h.js";import{F as B,P as x,S as c,D as p,a as r,H as b}from"./FeaturePage-kJ-jaNNu.js";import{F as L,D as T,P as R,C as P,O as F,M as H,L as $,R as E}from"./PlayerLedControls-BvBplWuy.js";import"./BatteryVisualization-B6wJ3WTh.js";import"./Switch-BI-2z897.js";import{C as a}from"./CodeBlock-C5O9LPzb.js";const u=n.div`
  display: flex;
...
`,M=n.span`
  ...
  min-width: 24px;
  text-align: right;
`;function z(s,l){const[t,o]=d.useState(s.state),i=d.useRef(0),[S,k]=d.useState(0);return d.useEffect(()=>{const v=()=>{const y=s.state;o(y),y&&(i.current+=1,k(i.current))};return s.on("change",v),()=>{s.removeListener("change",v)}},[s]),{label:l,active:t,pressCount:S}}const q=({data:s,even:l})=>{const t=s.label.split(".");return e.jsxs(I,{$even:l,children:[e.jsx(A,{$active:s.active}),e.jsxs(U,{children:[e.jsx(m,{children:"controller."}),t.map((o,i)=>e.jsxs(D.Fragment,{children:[i>0&&e.jsx(m,{children:"."}),i===t.length-1?o:e.jsx(m,{children:o})]},i))]}),e.jsx(w,{$active:s.active,children:s.active?"true":"false"}),e.jsx(w,{$active:s.active,children:s.active?"true":"false"}),e.jsx(M,{children:s.pressCount>0?s.pressCount:""})]})},N=[{label:"triangle",selector:s=>s.triangle},{label:"circle",selector:s=>s.circle},{label:"cross",selector:s=>s.cross},{label:"square",selector:s=>s.square}],_=[{label:"dpad.up",selector:s=>s.dpad.up},{label:"dpad.down",selector:s=>s.dpad.down},{label:"dpad.left",selector:s=>s.dpad.left},{label:"dpad.right",selector:s=>s.dpad.right}],V=[{label:"ps",selector:s=>s.ps},{label:"create",selector:s=>s.create},{label:"options",selector:s=>s.options},{label:"mute",selector:s=>s.mute}],Y=[{label:"left.bumper",selector:s=>s.left.bumper},{label:"right.bumper",selector:s=>s.right.bumper},{label:"left.trigger.button",selector:s=>s.left.trigger.button},{label:"right.trigger.button",selector:s=>s.right.trigger.button},{label:"left.analog.button",selector:s=>s.left.analog.button},{label:"right.analog.button",selector:s=>s.right.analog.button}],g=({buttons:s})=>{const l=d.useContext(C);return e.jsx(e.Fragment,{children:s.map((t,o)=>e.jsx(G,{input:t.selector(l),label:t.label,even:o%2===1},t.label))})},G=({input:s,label:l,even:t})=>{const o=z(s,l);return e.jsx(q,{data:o,even:t})},j=()=>e.jsxs(O,{children:[e.jsx("div",{style:{width:10,flexShrink:0}}),e.jsx(f,{style:{flex:1},children:"input"}),e.jsx(f,{style:{flexShrink:0,width:"5ch"},children:"state"}),e.jsx(f,{style:{flexShrink:0,width:"5ch"},children:"active"}),e.jsx("div",{style:{minWidth:24,flexShrink:0}})]}),W=()=>e.jsxs(u,{children:[e.jsx(j,{}),e.jsx(g,{buttons:N})]}),J=()=>e.jsxs(u,{children:[e.jsx(j,{}),e.jsx(g,{buttons:_})]}),K=()=>e.jsxs(u,{children:[e.jsx(j,{}),e.jsx(g,{buttons:V})]}),Q=()=>e.jsxs(u,{children:[e.jsx(j,{}),e.jsx(g,{buttons:Y})]}),oe=()=>e.jsxs(B,{title:"Buttons",subtitle:"Face buttons, D-Pad, and utility buttons.",children:[e.jsxs(x,{children:[e.jsxs("p",{children:["The DualSense exposes 18 discrete button inputs. Each is a"," ",e.jsx(h,{to:"/api/momentary",children:e.jsx("code",{children:"Momentary"})})," ","input with boolean state - pressed (",e.jsx("code",{children:"true"}),") or released (",e.jsx("code",{children:"false"}),"). Every button is an"," ",e.jsx(h,{to:"/api/input",children:e.jsx("code",{children:"Input<boolean>"})})," ","with the same event API: ",e.jsx("code",{children:'.on("press")'}),","," ",e.jsx("code",{children:'.on("release")'}),", ",e.jsx("code",{children:'.on("change")'}),"."]}),e.jsxs("p",{children:["The tables below show both ",e.jsx("code",{children:".state"})," and"," ",e.jsx("code",{children:".active"})," for each button. For boolean inputs these are identical; ",e.jsx("code",{children:".active"})," just returns ",e.jsx("code",{children:".state"}),". For analog inputs like sticks and triggers, ",e.jsx("code",{children:".state"})," is the raw numeric value while ",e.jsx("code",{children:".active"})," is a derived boolean (e.g. whether the stick has moved past its deadzone)."]})]}),e.jsx(c,{children:"Face Buttons"}),e.jsx(p,{children:"Live State - press buttons on your controller"}),e.jsx(r,{style:{padding:0,border:"none",background:"none",minHeight:0},children:e.jsxs("div",{style:{display:"flex",gap:24,width:"100%",alignItems:"center"},children:[e.jsx(r,{style:{flex:"0 0 auto",margin:0,minHeight:0},children:e.jsx(L,{})}),e.jsx("div",{style:{flex:1},children:e.jsx(W,{})})]})}),e.jsx(a,{code:`// Face buttons
...
await controller.square.promise("press");`})]});export{oe as default};
