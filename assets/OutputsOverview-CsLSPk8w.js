...
controller.audio.muteHeadphone(false);`}),e.jsx(s,{children:"Output API Pattern"}),e.jsx(r,{children:e.jsx("p",{children:"Outputs follow a consistent pattern: call a setter method to change state, read it back via a getter. The library batches your changes and sends them in the next HID output report, so you never need to manage timing or report construction yourself."})}),e.jsx(l,{code:`// Set → read back
...
controller.audio.speakerVolume;           // 0.8`})]});export{h as default};
