...
interface DualsenseDeviceInfo {
  ...
  serialNumber?: string;
  wireless: boolean;
}`}),e.jsx(n,{children:"HID State"}),e.jsx(s,{children:e.jsxs("p",{children:["The ",e.jsx("code",{children:"DualsenseHIDState"})," interface maps every ",e.jsx("code",{children:"InputId"})," ","to its raw value. This is the low-level state object you'd use if working directly with the HID provider rather than the ",e.jsx("code",{children:"Input"})," tree."]})})]});export{l as default};
