import{a as r,d as u,j as t,g as a,E as T}from"./index-B3Vc337h.js";const $=typeof navigator<"u"&&"hid"in navigator;function z(){const e=r.useRef(null),l=r.useRef(null),o=r.useRef(null),[p,c]=r.useState(!1),[,x]=r.useState(0);if(!o.current&&$){const s=new u.AccessWebHIDProvider,i=new u.AccessHID(s),b=new u.DualsenseAccess({hid:i});e.current=s,l.current=i,o.current=b}r.useEffect(()=>{const s=o.current;if(!s)return;const i=()=>{c(s.connection.state)},b=()=>x(h=>h+1);return s.connection.on("change",i),s.on("change",b),()=>{s.connection.removeListener("change",i),s.removeListener("change",b)}},[]);const f=r.useCallback(()=>{e.current&&e.current.getRequest()()},[]);return{access:o.current,connected:p,requestConnect:f,supported:$}}const L=a.div`
  max-width: 900px;
  margin: 0 auto;
