...
);`}),e.jsx(t,{children:e.jsxs("p",{children:["With this pattern, every ",e.jsx("code",{children:"useControllerInput"})," hook works in any browser — it just always reads the default state when WebHID is unavailable. Show a compatibility message where appropriate:"]})}),e.jsx(n,{code:`import { hasWebHID, requestPermission } from "./controller";
