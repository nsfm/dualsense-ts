import{j as e,L as o}from"./index-B3Vc337h.js";import{F as c,P as t,S as r,H as s}from"./FeaturePage-kJ-jaNNu.js";import{C as n}from"./CodeBlock-C5O9LPzb.js";import"./Switch-BI-2z897.js";const u=()=>e.jsxs(c,{title:"React Apps",subtitle:"Patterns for integrating dualsense-ts into React applications.",children:[e.jsx(t,{children:e.jsxs("p",{children:["The library's event-driven ",e.jsx(o,{to:"/api/input",children:e.jsx("code",{children:"Input"})})," ","API is a natural fit for React. A singleton controller or manager instance lives outside the component tree, React contexts make it available to any component, and lightweight hooks bridge the event system to React's render cycle."]})}),e.jsx(r,{children:"Single Controller Setup"}),e.jsx(t,{children:e.jsxs("p",{children:["For single-player apps, create one ",e.jsx("code",{children:"Dualsense"})," instance at module scope and expose it through a context. Components never construct their own; they consume the shared instance."]})}),e.jsx(n,{code:`// controller.ts
...
);`}),e.jsx(r,{children:"useControllerInput Hook"}),e.jsx(t,{children:e.jsx("p",{children:"This hook subscribes a component to a specific input and re-renders when it changes. The selector function picks which input to watch, and the hook handles event subscription and cleanup."})}),e.jsx(n,{code:`// useControllerInput.ts
...
export function useControllerInput<T extends Input<T>>(
  ...
  return input;
}`}),e.jsx(t,{children:e.jsxs("p",{children:["The returned ",e.jsx("code",{children:"Input"})," object always reflects the latest state. Read its properties directly in your JSX, without any separate state variables."]})}),e.jsx(n,{code:`function TriggerPressure() {
...
}`}),e.jsx(r,{children:"Browser Compatibility"}),e.jsx(t,{children:e.jsxs("p",{children:[e.jsx("a",{href:"https://developer.mozilla.org/en-US/docs/Web/API/WebHID_API#browser_compatibility",target:"_blank",rel:"noopener noreferrer",children:"WebHID"})," ","is supported in Chromium-based browsers (Chrome, Edge, Opera) but not in Firefox or Safari. Your app should still render in unsupported browsers: guard the manager and use a headless placeholder so the component tree mounts without errors."]})}),e.jsx(n,{code:`// controller.ts
import { createContext } from "react";
import { Dualsense, DualsenseManager } from "dualsense-ts";
...
);`}),e.jsx(t,{children:e.jsxs("p",{children:["With this pattern, every ",e.jsx("code",{children:"useControllerInput"})," hook works in any browser; when WebHID is unavailable, it just reads the default state. Show a compatibility message where appropriate:"]})}),e.jsx(n,{code:`import { hasWebHID, requestPermission } from "./controller";
