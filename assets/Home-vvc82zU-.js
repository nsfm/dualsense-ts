import{j as t,m as i,r as a,L as s,g as e}from"./index-B3Vc337h.js";import{C as l}from"./Switch-BI-2z897.js";import"./CodeBlock-C5O9LPzb.js";const c=e.code`
...
`,w=e.h2`
  ...
  margin-bottom: 16px;
  font-size: 20px;
`,j=[{title:"Buttons & D-Pad",desc:"Read every button press with events, promises, or async iterators.",to:"/inputs/buttons"},{title:"Analog Sticks",desc:"Two thumbsticks with X/Y axes, magnitude, direction, and click.",to:"/inputs/analog"},{title:"Triggers",desc:"Pressure-sensitive L2/R2 with full 0–1 range reading.",to:"/inputs/triggers"},{title:"Touchpad",desc:"Multi-touch surface with two independent contact points.",to:"/inputs/touchpad"},{title:"Motion Sensors",desc:"6-axis IMU: 3-axis gyroscope and 3-axis accelerometer.",to:"/inputs/motion"},{title:"Battery",desc:"Battery level and charging status with change events.",to:"/inputs/battery"},{title:"Connection",desc:"Auto-connect, reconnection, and USB/Bluetooth transport detection.",to:"/inputs/connection"},{title:"Adaptive Triggers",desc:"7 feedback effects with configurable parameters per trigger.",to:"/outputs/trigger-effects"},{title:"Haptic Feedback",desc:"Independent left and right rumble motors with intensity control.",to:"/outputs/rumble"},{title:"Lightbar",desc:"Full RGB LED strip with color control and fade effects.",to:"/outputs/lightbar"},{title:"Player LEDs",desc:"5 white LEDs with individual control and brightness levels.",to:"/outputs/player-leds"},{title:"Mute LED",desc:"Software-controlled mute indicator with solid, pulse, and off modes.",to:"/outputs/mute-led"},{title:"Audio Controls",desc:"Speaker, headphone, and microphone volume, routing, and test tones.",to:"/outputs/audio"},{title:"Controller Info",desc:"Body color, serial number, firmware versions, and factory data.",to:"/status"},{title:"Multiplayer",desc:"Up to 31 controllers with identity-based reconnection and player LEDs.",to:"/multiplayer"},{title:"DualSense Access",desc:"Hardware inputs, profile-mapped controls, 4 LED systems, and full DualSense API compatibility.",to:"/access"}],D=()=>t.jsxs(t.Fragment,{children:[t.jsxs(d,{children:[t.jsx(p,{children:t.jsx(u,{children:"dualsense-ts"})}),t.jsx(g,{children:"The natural interface for your DualSense and DualSense Access controllers."}),t.jsxs(r,{children:["Fully featured with support via WebHID in the browser or"," ",t.jsx(c,{children:"node-hid"})," in Node.js. Connect your controller to explore the"," ",t.jsx(n,{to:"/playground",children:"interactive playground"}),", or see your inputs live on every page of the docs. You can also connect multiple controllers and swap between them at any time from the top bar."]}),i&&t.jsx(x,{onClick:a,children:"Connect a Controller"}),t.jsxs(r,{style:{marginTop:16,marginBottom:0},children:[t.jsx("br",{}),"Have a DualSense Access controller? Try the"," ",t.jsx(n,{to:"/access/playground",children:"Access playground"}),"."]})]}),t.jsx(h,{children:"npm install dualsense-ts"}),t.jsx(w,{children:"Features"}),t.jsx(m,{children:j.map(o=>t.jsx(s,{to:o.to,style:{textDecoration:"none"},children:t.jsxs(b,{$interactive:!0,children:[t.jsx(f,{children:o.title}),t.jsx(y,{children:o.desc})]})},o.to))})]});export{D as default};
