import{a as t,C as b,d as y,j as e,g as h,L as q}from"./index-B3Vc337h.js";import{F as z,P as f,H as D,S as u,D as H}from"./FeaturePage-kJ-jaNNu.js";import{C as x}from"./CodeBlock-C5O9LPzb.js";import"./Switch-BI-2z897.js";const j=h.div`
  display: flex;
...
});`}),e.jsx(u,{children:"Vibration"}),e.jsx(f,{children:e.jsxs("p",{children:["Zone-based oscillation: the trigger vibrates from the"," ",e.jsx("code",{children:"position"})," point onward. Good for engine rumble, terrain feedback, or any continuous haptic texture."]})}),e.jsx(_,{}),e.jsx(x,{code:`controller.right.trigger.feedback.set({
  effect: TriggerEffect.Vibration,
  position: 0.1,   // vibration starts at 10% travel
  amplitude: 0.7,  // 0–1
  frequency: 40,   // Hz (1–255)
});`}),e.jsx(u,{children:"Machine"}),e.jsx(f,{children:e.jsx("p",{children:"Dual-amplitude vibration that alternates between two intensity levels at a configurable frequency and period. The most complex of the effects; think machinery, engines, or other rhythmic motion."})}),e.jsx(I,{}),e.jsx(x,{code:`controller.right.trigger.feedback.set({
...
});`}),e.jsx(u,{children:"Resetting"}),e.jsx(f,{children:e.jsx("p",{children:"Reset a single trigger to the default linear feel, or reset both at once. The trigger immediately returns to zero resistance."})}),e.jsx(N,{}),e.jsx(x,{code:`// Reset a single trigger
controller.right.trigger.feedback.reset();

// Reset both triggers at once
controller.resetTriggerFeedback();`}),e.jsx(u,{children:"Reading State"}),e.jsx(f,{children:e.jsx("p",{children:"You can read the current effect type and the full configuration object at any time. Your editor's type hints will narrow the config type based on the active effect."})}),e.jsx(x,{code:`// Current effect type
controller.right.trigger.feedback.effect; // TriggerEffect.Off

// Full configuration object
controller.right.trigger.feedback.config;
// { effect: "weapon", start: 0.2, end: 0.6, strength: 0.9 }`})]})};export{ee as default};
