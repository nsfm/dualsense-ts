import{j as e,L as s}from"./index-B3Vc337h.js";import{F as o,P as r,S as t}from"./FeaturePage-kJ-jaNNu.js";import{C as n}from"./CodeBlock-C5O9LPzb.js";import"./Switch-BI-2z897.js";const a=()=>e.jsxs(o,{title:"Inputs",subtitle:"Every input on the DualSense controller is accessible through a unified API.",children:[e.jsx(r,{children:e.jsxs("p",{children:["The"," ",e.jsx(s,{to:"/api/input",children:e.jsx("code",{children:"Input<T>"})})," base class provides a consistent interface across all controller inputs:"," ",e.jsx(s,{to:"/inputs/buttons",children:"buttons"}),","," ",e.jsx(s,{to:"/inputs/triggers",children:"triggers"}),","," ",e.jsx(s,{to:"/inputs/analog",children:"analog sticks"}),","," ",e.jsx(s,{to:"/inputs/touchpad",children:"touchpad"}),","," ",e.jsx(s,{to:"/inputs/motion",children:"motion sensors"}),", and"," ",e.jsx(s,{to:"/inputs/battery",children:"battery level"})," all support the same four access patterns."]})}),e.jsx(t,{children:"Synchronous Reads"}),e.jsx(r,{children:e.jsx("p",{children:"Read the current value at any time. When the controller is disconnected, all inputs reset to their neutral state."})}),e.jsx(n,{code:`// Boolean inputs
...
}`}),e.jsx(t,{children:"Nested Inputs"}),e.jsx(r,{children:e.jsxs("p",{children:["Compound inputs like"," ",e.jsx(s,{to:"/api/unisense",children:e.jsx("code",{children:"Unisense"})})," (left/right halves), ",e.jsx(s,{to:"/api/dpad",children:e.jsx("code",{children:"Dpad"})}),","," ",e.jsx(s,{to:"/api/touchpad",children:e.jsx("code",{children:"Touchpad"})}),", and"," ",e.jsx(s,{to:"/api/battery",children:e.jsx("code",{children:"Battery"})})," contain sub-inputs. You can subscribe at any level, since changes in children propagate upward."]})}),e.jsx(n,{code:`// Listen to all left-side inputs at once
