import{j as e,g as s,a as t,C as re,L as I}from"./index-B3Vc337h.js";import{F as ae,P as n,H as X,S as i,D as ne,a as ie}from"./FeaturePage-kJ-jaNNu.js";import{C as l}from"./CodeBlock-C5O9LPzb.js";import"./Switch-BI-2z897.js";const ce=s.div`
  display: flex;
...
controller.powerSave.audio = false;`}),e.jsxs(X,{children:["The controller does not report power save status back in the input report. ",e.jsx("code",{children:"controller.powerSave"})," is always the authoritative source of truth for which flags have been sent."]}),e.jsx(i,{children:"Battery Optimization Example"}),e.jsx(n,{children:e.jsx("p",{children:"A typical optimization for a game that only uses buttons and analog sticks is to disable everything else:"})}),e.jsx(l,{code:`import { Dualsense } from "dualsense-ts";
...
controller.powerSave.motion = true;`})]});export{we as default};
