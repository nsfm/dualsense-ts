import{a as o,C as w,j as e,d as a,g as s,L as v}from"./index-B3Vc337h.js";import{F as q,P as j,H as V,S as M,D as F}from"./FeaturePage-kJ-jaNNu.js";import{C as S}from"./CodeBlock-C5O9LPzb.js";import"./Switch-BI-2z897.js";const H=s.div`
  display: flex;
...
`,C=s.div`
  ...
  letter-spacing: 0.05em;
  color: rgba(191, 204, 214, 0.3);
`,D=({label:t,value:r,onChange:p,min:n=0,max:l=1,step:d=.01,format:x,even:i,color:m})=>{const h=(r-n)/(l-n)*100;return e.jsxs(J,{$even:i,children:[e.jsx(K,{children:t}),e.jsxs(Z,{children:[e.jsx(ee,{style:{width:`${h}%`},$color:m}),e.jsx(te,{style:{left:`${h}%`}}),e.jsx(oe,{type:"range",min:n,max:l,step:d,value:r,onChange:f=>p(Number(f.target.value))})]}),e.jsx(X,{children:x?x(r):`${Math.round(r*100)}%`})]})},re=()=>{const t=o.useContext(w),[r,p]=o.useState(t.audio.speakerVolume),[n,l]=o.useState(t.audio.headphoneVolume),[d,x]=o.useState(t.audio.microphoneVolume),[i,m]=o.useState(t.audio.speakerMuted),[h,f]=o.useState(t.audio.headphoneMuted),[k,R]=o.useState(t.audio.microphoneMuted),[u,T]=o.useState(t.mute.status.state);o.useEffect(()=>{const g=()=>T(t.mute.status.state);return t.mute.status.on("change",g),()=>{t.mute.status.removeListener("change",g)}},[t]);const U=o.useCallback(g=>{p(g),t.audio.setSpeakerVolume(g)},[t]),N=o.useCallback(g=>{l(g),t.audio.setHeadphoneVolume(g)},[t]),G=o.useCallback(g=>{x(g),t.audio.setMicrophoneVolume(g)},[t]),W=o.useCallback(()=>{t.audio.muteSpeaker(!i),m(!i)},[t,i]),Q=o.useCallback(()=>{t.audio.muteHeadphone(!h),f(!h)},[t,h]),Y=o.useCallback(()=>{t.audio.muteMicrophone(!k),R(!k)},[t,k]);return e.jsxs(H,{children:[e.jsx(y,{children:e.jsx(A,{children:"volume & mute"})}),e.jsx(D,{label:"speaker",value:r,onChange:U}),e.jsx(D,{label:"headphone",value:n,onChange:N,even:!0}),e.jsx(D,{label:"microphone",value:d,onChange:G}),e.jsx(C,{children:"mute"}),e.jsxs($,{children:[e.jsx(I,{$muted:i,onClick:W,children:i?"Speaker Muted":"Speaker"}),e.jsx(I,{$muted:h,onClick:Q,children:h?"Headphone Muted":"Headphone"}),e.jsx(I,{$muted:k,onClick:Y,children:k?"Mic Muted":"Mic"})]}),e.jsxs(O,{children:[e.jsx(_,{children:e.jsxs("bdi",{children:[e.jsx(b,{children:"controller."}),"mute",e.jsx(b,{children:"."}),"status",e.jsx(b,{children:"."}),"state"]})}),e.jsx(P,{$highlight:u,children:u?"true (muted)":"false"})]})]})};function ae(t){switch(t){case a.AudioOutput.Headphone:return"AudioOutput.Headphone";case a.AudioOutput.HeadphoneMono:return"AudioOutput.HeadphoneMono";case a.AudioOutput.Split:return"AudioOutput.Split";case a.AudioOutput.Speaker:return"AudioOutput.Speaker";default:return`${t}`}}const se=()=>{const t=o.useContext(w),[r,p]=o.useState(t.audio.output),n=o.useCallback(l=>{p(l),t.audio.setOutput(l)},[t]);return e.jsxs(H,{children:[e.jsx(y,{children:e.jsx(A,{children:"output routing"})}),e.jsxs($,{children:[e.jsx(c,{$active:r===a.AudioOutput.Headphone,onClick:()=>n(a.AudioOutput.Headphone),children:"Headphone"}),e.jsx(c,{$active:r===a.AudioOutput.HeadphoneMono,onClick:()=>n(a.AudioOutput.HeadphoneMono),children:"HP Mono"}),e.jsx(c,{$active:r===a.AudioOutput.Split,onClick:()=>n(a.AudioOutput.Split),children:"Split"}),e.jsx(c,{$active:r===a.AudioOutput.Speaker,onClick:()=>n(a.AudioOutput.Speaker),children:"Speaker"})]}),e.jsxs(O,{children:[e.jsx(_,{children:e.jsxs("bdi",{children:[e.jsx(b,{children:"controller."}),"audio",e.jsx(b,{children:"."}),"output"]})}),e.jsx(P,{$highlight:r!==a.AudioOutput.Headphone,children:ae(r)})]})]})},ie=()=>{const t=o.useContext(w),[r,p]=o.useState(null),[n,l]=o.useState(a.MicMode.Default),[d,x]=o.useState(t.audio.preampGain),[i,m]=o.useState(t.audio.beamForming),h=o.useCallback(u=>{p(u),t.audio.setMicSelect(u)},[t]),f=o.useCallback(u=>{l(u),t.audio.setMicMode(u)},[t]),k=o.useCallback(u=>{const T=Math.round(u);x(T),t.audio.setPreamp(T,i)},[t,i]),R=o.useCallback(()=>{const u=!i;m(u),t.audio.setPreamp(d,u)},[t,d,i]);return e.jsxs(H,{children:[e.jsx(y,{children:e.jsx(A,{children:"microphone"})}),e.jsx(C,{children:"source"}),e.jsxs($,{children:[e.jsx(c,{$active:r===a.MicSelect.Internal,onClick:()=>h(a.MicSelect.Internal),children:"Internal"}),e.jsx(c,{$active:r===a.MicSelect.Headset,onClick:()=>h(a.MicSelect.Headset),children:"Headset"})]}),e.jsx(C,{children:"mode"}),e.jsxs($,{children:[e.jsx(c,{$active:n===a.MicMode.Default,onClick:()=>f(a.MicMode.Default),children:"Default"}),e.jsx(c,{$active:n===a.MicMode.Chat,onClick:()=>f(a.MicMode.Chat),children:"Chat"}),e.jsx(c,{$active:n===a.MicMode.ASR,onClick:()=>f(a.MicMode.ASR),children:"ASR"})]}),e.jsx(C,{children:"preamp"}),e.jsx(D,{label:"gain",value:d,onChange:k,min:0,max:7,step:1,format:u=>`${Math.round(u)}`}),e.jsx($,{children:e.jsxs(c,{$active:i,onClick:R,children:["Beam Forming ",i?"On":"Off"]})}),e.jsxs(O,{children:[e.jsx(_,{children:e.jsxs("bdi",{children:[e.jsx(b,{children:"controller."}),"audio",e.jsx(b,{children:"."}),"preampGain"]})}),e.jsx(P,{children:d})]}),e.jsxs(O,{$even:!0,children:[e.jsx(_,{children:e.jsxs("bdi",{children:[e.jsx(b,{children:"controller."}),"audio",e.jsx(b,{children:"."}),"beamForming"]})}),e.jsx(P,{$highlight:i,children:i?"true":"false"})]})]})},ce=()=>{const t=o.useContext(w),[r,p]=o.useState("speaker"),[n,l]=o.useState(!1),d=o.useRef(n);d.current=n;const x=o.useCallback(async m=>{n===m?(await t.stopTestTone(),l(!1)):(n&&await t.stopTestTone(),await t.startTestTone(r,m),l(m))},[t,n,r]),i=o.useCallback(async()=>{await t.stopTestTone(),l(!1)},[t]);return o.useEffect(()=>()=>{d.current&&t.stopTestTone()},[t]),e.jsxs(H,{children:[e.jsx(y,{children:e.jsx(A,{children:"test tones"})}),e.jsx(C,{children:"target"}),e.jsxs($,{children:[e.jsx(c,{$active:r==="speaker",onClick:()=>p("speaker"),children:"Speaker"}),e.jsx(c,{$active:r==="headphone",onClick:()=>p("headphone"),children:"Headphone"})]}),e.jsx(C,{children:"tone"}),e.jsxs($,{children:[e.jsx(c,{$active:n==="1khz",onClick:()=>x("1khz"),children:"1 kHz"}),e.jsx(c,{$active:n==="100hz",onClick:()=>x("100hz"),children:"~100 Hz"}),e.jsx(c,{$active:n==="both",onClick:()=>x("both"),children:"Both"}),e.jsx(ne,{onClick:i,children:"Stop"})]})]})},z=s.div`
  width: 8px;
  height: 8px;
  border-radius: 50%;
...
pactl set-sink-volume \\
  alsa_output.usb-Sony_Interactive_Entertainment_Wireless_Controller-00.HiFi__Headphones__sink 100%`})]});export{xe as default};
