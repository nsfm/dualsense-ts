import{b as bn,R as f,a as S,g as y,C as z,j as n,d as m,E as Fr,f as wn}from"./index-B3Vc337h.js";import{T as Mt,S as Ut,B as jn,C as Ot,a as Ke}from"./Switch-BI-2z897.js";import"./CodeBlock-C5O9LPzb.js";var Xt={exports:{}},Yt={exports:{}};/*!
 * Zdog v1.1.3
...
`,Rs=y.span`
  ...
  letter-spacing: 2px;
  opacity: 0.4;
`,ze=16,zs=Math.PI/5,Ms=2.4,tn=1.8,en=2.2,jr=.5,Ts=.5,Ps="#48aff0",$s="#f29e02",_s=.7,It=({x:t,z:i,pressed:e,rotateY:r=0,wide:o=!1})=>{const c=(o?en:tn)/2,u=Ms/2,s=e?$s:Ps;return n.jsxs(C,{translate:{x:t,z:i,y:e?Ts:0},rotate:{y:r},stroke:0,children:[n.jsx(C,{path:[{x:0,y:0,z:-u-_s},{x:-c,y:0,z:-u},{x:-c,y:0,z:u},{x:c,y:0,z:u},{x:c,y:0,z:-u}],stroke:.2,color:s,fill:e,closed:!0}),n.jsx(C,{path:[{x:-jr,y:0,z:u*.2},{x:0,y:0,z:u*.7},{x:jr,y:0,z:u*.2}],stroke:.2,color:s,closed:!1})]})},Ki=()=>{const t=f.useContext(z),[i,e]=f.useState(t.dpad.up.state),[r,o]=f.useState(t.dpad.down.state),[c,u]=f.useState(t.dpad.left.state),[s,h]=f.useState(t.dpad.right.state);f.useEffect(()=>{t.dpad.up.on("change",({state:a})=>e(a)),t.dpad.down.on("change",({state:a})=>o(a)),t.dpad.left.on("change",({state:a})=>u(a)),t.dpad.right.on("change",({state:a})=>h(a))},[]);const l=2.8;return n.jsxs(ks,{children:[n.jsx(ct,{width:(l*2+en+2)*ze,height:(l*2+tn+3)*ze,children:n.jsx(at,{element:"svg",zoom:ze,children:n.jsxs(C,{rotate:{x:zs},stroke:0,children:[n.jsx(It,{x:0,z:l,pressed:i}),n.jsx(It,{x:0,z:-l,pressed:r,rotateY:Math.PI}),n.jsx(It,{x:-l,z:0,pressed:c,rotateY:Math.PI/2,wide:!0}),n.jsx(It,{x:l,z:0,pressed:s,rotateY:-Math.PI/2,wide:!0})]})})}),n.jsx(Rs,{children:"D-pad"})]})},As=y.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 8px;
...
`,Is=y.div`
  ...
  flex-direction: column;
  align-items: center;
`,Ft=14,kr=Math.PI/5,K=3.5,ht=5,Bs=Math.PI/5,kt=3.5,Dt=1,Fs=.4,Te=2,Pe="#48aff0",$e="#f29e02",rn=({triggerLabel:t,bumperLabel:i,triggerPressure:e,triggerPressed:r,bumperPressed:o,labelSide:c})=>{const u=e*Bs,s=r?$e:Pe,h=r?"#ff8c00":e>0?`rgba(242, 158, 2, ${.2+e*.8})`:"rgba(72, 175, 240, 0.3)",l=o?$e:Pe,a=ht+Te+Dt,d=(Math.max(K,kt)+2)*Ft,p=(a+3)*Ft,g=n.jsx(ct,{width:d,height:p,children:n.jsx(at,{element:"svg",zoom:Ft,children:n.jsxs(C,{rotate:{x:-kr},stroke:0,children:[n.jsx(C,{path:[{x:-K/2,y:0,z:0},{x:K/2,y:0,z:0},{x:K/2,y:0,z:-ht},{x:-K/2,y:0,z:-ht}],stroke:.3,color:s,fill:!1,closed:!0}),n.jsx(C,{rotate:{x:u},stroke:0,children:n.jsx(C,{path:[{x:-K/2+.3,y:0,z:-ht+.3},{x:K/2-.3,y:0,z:-ht+.3},{x:K/2-.3,y:0,z:-.3},{x:-K/2+.3,y:0,z:-.3}],stroke:.4,color:h,fill:!0,closed:!0})}),n.jsx(O,{diameter:.6,stroke:.2,color:r?$e:Pe,translate:{y:e*2,z:-ht-.3}}),n.jsx(C,{translate:{z:Te},stroke:0,children:n.jsx(C,{path:[{x:-kt/2,y:0,z:0},{x:kt/2,y:0,z:0},{x:kt/2,y:0,z:Dt},{x:-kt/2,y:0,z:Dt}],stroke:.3,color:l,fill:o,closed:!0,translate:{y:o?Fs:0}})})]})})}),x=(ht/2+Te+Dt/2)*Ft*Math.cos(kr),v=n.jsxs(Is,{style:{gap:`${x}px`},children:[n.jsx(Er,{style:{marginTop:6},children:t}),n.jsx(Er,{style:{marginTop:-6},children:i})]});return n.jsx(Os,{children:c==="right"?n.jsxs(n.Fragment,{children:[g,v]}):n.jsxs(n.Fragment,{children:[v,g]})})},Qi=()=>{const t=f.useContext(z),[i,e]=f.useState(t.left.trigger.pressure),[r,o]=f.useState(t.left.trigger.button.state),[c,u]=f.useState(t.left.bumper.state);return f.useEffect(()=>{t.left.trigger.on("change",({pressure:s})=>e(s)),t.left.trigger.button.on("change",({state:s})=>o(s)),t.left.bumper.on("change",({state:s})=>u(s))},[]),n.jsx(rn,{triggerLabel:"L2",bumperLabel:"L1",triggerPressure:i,triggerPressed:r,bumperPressed:c,labelSide:"right"})},Zi=()=>{const t=f.useContext(z),[i,e]=f.useState(t.right.trigger.pressure),[r,o]=f.useState(t.right.trigger.button.state),[c,u]=f.useState(t.right.bumper.state);return f.useEffect(()=>{t.right.trigger.on("change",({pressure:s})=>e(s)),t.right.trigger.button.on("change",({state:s})=>o(s)),t.right.bumper.on("change",({state:s})=>u(s))},[]),n.jsx(rn,{triggerLabel:"R2",bumperLabel:"R1",triggerPressure:i,triggerPressed:r,bumperPressed:c,labelSide:"left"})},Ds=y.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 4px;
...
`,Us=y.span`
  ...
  opacity: 0.25;
`,Rt=22,J=48,Xs="#48aff0",Ys="#f29e02",nn=({value:t,onChange:i,label:e})=>{const r=f.useRef(null),o=f.useRef(!1),c=f.useCallback(a=>{const d=r.current;if(!d)return;const p=d.getBoundingClientRect(),g=a.clientY-p.top,x=Math.max(0,Math.min(1,1-g/p.height)),v=Math.round(x*20)/20;i(v)},[i]),u=f.useCallback(a=>{o.current=!0,c(a);const d=g=>{o.current&&c(g)},p=()=>{o.current=!1,window.removeEventListener("mousemove",d),window.removeEventListener("mouseup",p)};window.addEventListener("mousemove",d),window.addEventListener("mouseup",p)},[c]),s=t*J,h=t>0?Ys:Xs,l=Math.round(t*100);return n.jsxs(Vs,{title:`${e}: ${l}% - drag to adjust`,children:[n.jsxs("svg",{ref:r,width:Rt,height:J,style:{cursor:"ns-resize",borderRadius:3},onMouseDown:u,children:[n.jsx("rect",{x:0,y:0,width:Rt,height:J,fill:"rgba(72, 175, 240, 0.1)",rx:2}),n.jsx("rect",{x:.5,y:.5,width:Rt-1,height:J-1,fill:"none",stroke:"rgba(72, 175, 240, 0.3)",strokeWidth:1,rx:2}),s>0&&n.jsx("rect",{x:2,y:J-s,width:Rt-4,height:s,fill:h,opacity:.3+t*.7,rx:1}),t>0&&n.jsx("line",{x1:1,y1:J-s,x2:Rt-1,y2:J-s,stroke:h,strokeWidth:1,opacity:.8}),[.25,.5,.75].map(a=>n.jsx("line",{x1:0,y1:J*(1-a),x2:2,y2:J*(1-a),stroke:"rgba(72, 175, 240, 0.2)",strokeWidth:.5},a))]}),n.jsx(Ns,{children:e}),n.jsx(Us,{children:"drag me"})]})},ro=()=>{const t=f.useContext(z),[i,e]=f.useState(t.left.rumble()),r=f.useCallback(o=>{e(o),t.left.rumble(o)},[t]);return n.jsx(nn,{value:i,onChange:r,label:"Rumble"})},no=()=>{const t=f.useContext(z),[i,e]=f.useState(t.right.rumble()),r=f.useCallback(o=>{e(o),t.right.rumble(o)},[t]);return n.jsx(nn,{value:i,onChange:r,label:"Rumble"})};function Ks(t,i,e){return"#"+[t,i,e].map(r=>r.toString(16).padStart(2,"0")).join("")}function Js(t){const i=parseInt(t.slice(1),16);return{r:i>>16&255,g:i>>8&255,b:i&255}}const Qs=y.div`
  position: relative;
  cursor: pointer;
`,Zs=y.div`
  width: 100%;
...
`,ei=y.input`
  ...
  opacity: 0;
  pointer-events: none;
`,so=()=>{const t=f.useContext(z),i=t.lightbar.color,[e,r]=f.useState(Ks(i.r,i.g,i.b)),o=f.useRef(null),c=f.useCallback(s=>{const h=s.target.value;r(h),t.lightbar.set(Js(h))},[t]),u=f.useCallback(()=>{var s;(s=o.current)==null||s.click()},[]);return n.jsxs(Qs,{onClick:u,title:"Click to change lightbar color",children:[n.jsx(Zs,{$color:e,children:n.jsx(ti,{children:"click to adjust lights"})}),n.jsx(ei,{ref:o,type:"color",value:e,onChange:c})]})},ri=y.div`
  display: flex;
  align-items: center;
  gap: 6px;
  font-size: 11px;
...
`,io=()=>{const t=f.useContext(z),[i,e]=f.useState(t.connection.state);return f.useEffect(()=>{e(t.connection.state),t.connection.on("change",({state:r})=>e(r))},[t]),i?n.jsxs(ri,{children:[n.jsx(ni,{children:"Lightbar:"}),n.jsx($r,{onClick:()=>t.lightbar.fadeBlue(),children:"Fade Blue"}),n.jsx($r,{onClick:()=>t.lightbar.fadeOut(),children:"Fade Out"})]}):null},si=y.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 4px;
...
`,an=y.span`
  ...
  letter-spacing: 1px;
  opacity: 0.35;
`,jt=14,cn=Math.PI/6,hn=.4,ot=1.8,_r=2.8,Tt="#48aff0",Pt="#f29e02",qe=({label:t,pressed:i,size:e,children:r})=>n.jsxs(on,{children:[n.jsx(ct,{width:(e+2)*jt,height:(e+2)*jt,children:n.jsx(at,{element:"svg",zoom:jt,children:n.jsx(C,{rotate:{x:cn},stroke:0,children:n.jsx(C,{translate:{y:i?hn:0},stroke:0,children:r})})})}),n.jsx(an,{children:t})]}),ao=()=>{const t=f.useContext(z),[i,e]=f.useState(t.create.state);f.useEffect(()=>{t.create.on("change",({state:h})=>e(h))},[]);const r=i?Pt:Tt,o=ot*.35,c=o*.65,u=ot*.22,s=.08;return n.jsxs(qe,{label:"Create",pressed:i,size:ot,children:[n.jsx(O,{diameter:ot,stroke:.15,color:r}),n.jsx(C,{path:[{x:-u+s,y:0,z:-o},{x:-u-s,y:0,z:c}],stroke:.15,color:r}),n.jsx(C,{path:[{x:0,y:0,z:-o},{x:0,y:0,z:o}],stroke:.15,color:r}),n.jsx(C,{path:[{x:u-s,y:0,z:-o},{x:u+s,y:0,z:c}],stroke:.15,color:r})]})},co=()=>{const t=f.useContext(z),[i,e]=f.useState(t.options.state);f.useEffect(()=>{t.options.on("change",({state:s})=>e(s))},[]);const r=i?Pt:Tt,o=ot*.3,c=o*.7,u=ot*.24;return n.jsxs(qe,{label:"Options",pressed:i,size:ot,children:[n.jsx(O,{diameter:ot,stroke:.15,color:r}),n.jsx(C,{path:[{x:-c,y:0,z:-u},{x:c,y:0,z:-u}],stroke:.15,color:r}),n.jsx(C,{path:[{x:-o,y:0,z:0},{x:o,y:0,z:0}],stroke:.15,color:r}),n.jsx(C,{path:[{x:-c,y:0,z:u},{x:c,y:0,z:u}],stroke:.15,color:r})]})},ho=()=>{const t=f.useContext(z),[i,e]=f.useState(t.ps.state);f.useEffect(()=>{t.ps.on("change",({state:d})=>e(d))},[]);const r=i?Pt:Tt,o=i?Tt:r,c=.18,u=-.38,s=.42,h=.95,l=-.85,a=.05;return n.jsxs(qe,{label:"PS",pressed:i,size:_r,children:[n.jsx(O,{diameter:_r,stroke:.25,color:r,fill:i}),n.jsx(C,{path:[{x:u,y:0,z:h},{x:u,y:0,z:l}],stroke:c,color:o}),n.jsx(C,{path:[{x:u,y:0,z:h},{arc:[{x:u+.65,y:0,z:h},{x:u+.65,y:0,z:(h+a)/2}]},{arc:[{x:u+.65,y:0,z:a},{x:u,y:0,z:a}]}],stroke:c,color:o,closed:!1}),n.jsx(C,{path:[{x:s+.22,y:0,z:a},{x:s-.22,y:0,z:a},{x:s-.22,y:0,z:(a+l)/2},{x:s+.22,y:0,z:(a+l)/2},{x:s+.22,y:0,z:l},{x:s-.22,y:0,z:l}],stroke:c,color:o,closed:!1})]})},Ar=2.4,Lr=1,lo=()=>{const t=f.useContext(z),[i,e]=f.useState(t.mute.state),[r,o]=f.useState(t.mute.status.state),[c,u]=f.useState(!1),s=f.useRef(c);s.current=c,f.useEffect(()=>{t.mute.on("change",({state:g})=>e(g)),t.mute.status.on("change",({state:g})=>{o(g),s.current&&(t.mute.setLed(g?m.MuteLedMode.On:m.MuteLedMode.Off),u(!1))})},[]);const h=()=>{c?(t.mute.setLed(t.mute.status.state?m.MuteLedMode.On:m.MuteLedMode.Off),u(!1)):(t.mute.setLed(m.MuteLedMode.Pulse),u(!0))},l=r||c||i?Pt:Tt,a=Ar/2,d=Lr/2,p=d;return n.jsxs(on,{onClick:h,style:{cursor:"pointer"},children:[n.jsx(ct,{width:(Ar+2)*jt,height:(Lr+2)*jt,style:{pointerEvents:"none"},children:n.jsx(at,{element:"svg",zoom:jt,children:n.jsx(C,{rotate:{x:cn},stroke:0,children:n.jsx(C,{translate:{y:i?hn:0},stroke:0,children:n.jsx(C,{path:[{x:-a+p,y:0,z:-d},{x:a-p,y:0,z:-d},{arc:[{x:a,y:0,z:-d},{x:a,y:0,z:0}]},{arc:[{x:a,y:0,z:d},{x:a-p,y:0,z:d}]},{x:-a+p,y:0,z:d},{arc:[{x:-a,y:0,z:d},{x:-a,y:0,z:0}]},{arc:[{x:-a,y:0,z:-d},{x:-a+p,y:0,z:-d}]}],stroke:.15,color:l,fill:r||c,closed:!0})})})})}),n.jsx(an,{children:r?c?"Pulsing":"Muted":"Mute"})]})};y.div`
  display: flex;
  align-items: center;
  gap: 12px;
`;const pi=Fr`
...
`;const fi=y.div`
  ...
  align-items: center;
  gap: 8px;
`;function xi(t){switch(t){case m.ChargeStatus.Charging:return"Charging";case m.ChargeStatus.Full:return"Full";case m.ChargeStatus.Discharging:return"Battery";case m.ChargeStatus.AbnormalVoltage:return"Voltage Error";case m.ChargeStatus.AbnormalTemperature:return"Temp Error";case m.ChargeStatus.ChargingError:return"Error";default:return"Unknown"}}function gi(t,i){return i===m.ChargeStatus.Charging||i===m.ChargeStatus.Full?"success":t<.2?"danger":t<.4?"warning":"primary"}const uo=()=>{const t=S.useContext(z),[i,e]=S.useState(t.battery.level.state),[r,o]=S.useState(t.battery.status.state),[c,u]=S.useState(t.connection.state);if(S.useEffect(()=>{e(t.battery.level.state),o(t.battery.status.state),u(t.connection.state),t.battery.level.on("change",({state:a})=>e(a)),t.battery.status.on("change",({state:a})=>o(a)),t.connection.on("change",({state:a})=>u(a))},[t]),!c)return null;const s=Math.round(i*100),h=r===m.ChargeStatus.Charging||r===m.ChargeStatus.Full,l=n.jsxs("svg",{width:"18",height:"10",viewBox:"0 0 18 10",style:{display:"block"},children:[n.jsx("rect",{x:"0.5",y:"0.5",width:"14",height:"9",rx:"1.5",fill:"none",stroke:"currentColor",strokeWidth:"1"}),n.jsx("rect",{x:"15",y:"3",width:"2",height:"4",rx:"0.5",fill:"currentColor"}),n.jsx("rect",{x:"2",y:"2",width:Math.max(0,i*11),height:"6",rx:"0.5",fill:"currentColor",opacity:.6}),h&&n.jsx("path",{d:"M8 1.5 L6 5 L8.5 5 L7 8.5 L10 4.5 L7.5 4.5 L9 1.5Z",fill:"currentColor",opacity:.9})]});return n.jsx(fi,{children:n.jsxs(Mt,{$minimal:!0,$intent:gi(i,r),children:[l," ",xi(r),": ",s,"%"]})})},vi={"00":"#e8e8e8","01":"#1a1a2e","02":"#c8102e","03":"#f2a6c0","04":"#6b3fa0","05":"#5b9bd5","06":"#8a9a7b","07":"#9b2335","08":"#c0c0c0","09":"#1e3a5f",10:"#2db5a0",11:"#3d4f7c",12:"#e8dfd0",30:"#4a4a4a"},yi=y.span`
  ...
  flex-shrink: 0;
`,po=()=>{const t=S.useContext(z),[i,e]=S.useState(t.factoryInfo),[r,o]=S.useState(t.connection.state);if(S.useEffect(()=>{o(t.connection.state),e(t.factoryInfo),t.on("change",s=>{s.factoryInfo&&e(s.factoryInfo)}),t.connection.on("change",({state:s})=>{o(s),s||e(void 0)})},[t]),!r||!i)return null;const c=vi[i.colorCode],u=i.colorName??i.colorCode;return n.jsxs(Mt,{$minimal:!0,title:`Controller color: ${u}${i.boardRevision?` (${i.boardRevision})`:""}`,children:[c&&n.jsx(yi,{$color:c})," ",u]})},mi=y.div`
  display: flex;
  gap: 16px;
...
`;y.span`
  ...
  font-size: 12px;
  opacity: 0.7;
`;export{uo as B,ao as C,Ki as D,Yi as F,eo as G,Qi as L,lo as M,co as O,ho as P,Zi as R,Ji as S,to as T,po as a,io as b,fo as c,ro as d,so as e,no as f,oo as g};
