import{j as e,g as r,a as o,C as W,R as I,L as T}from"./index-B3Vc337h.js";import{F as O,P as p,D as U,H as w,S as f}from"./FeaturePage-kJ-jaNNu.js";import{C as j}from"./CodeBlock-C5O9LPzb.js";import"./Switch-BI-2z897.js";const M=r.div`
  display: flex;
...
// Stop all rumble
controller.rumble(0);`}),e.jsx(w,{children:"Rumble state is restored automatically if the controller disconnects and reconnects."}),e.jsx(f,{children:"Trigger Reactive Rumble"}),e.jsx(p,{children:e.jsxs("p",{children:["Wire rumble intensity to any input. For example, map the"," ",e.jsx(T,{to:"/inputs/triggers",children:"trigger pressure"})," directly to the corresponding motor. Try this now with the"," ",e.jsx("strong",{children:"Trigger Reactive"})," button above."]})}),e.jsx(j,{code:`// Rumble follows trigger pressure
...
});`}),e.jsx(f,{children:"Patterns"}),e.jsx(p,{children:e.jsxs("p",{children:["The library doesn't include a built-in pattern system, but it's easy to build one with timers. Hit the"," ",e.jsx("strong",{children:"Pulse Pattern"})," button above to try this example:"]})}),e.jsx(j,{code:`async function pulse(count: number, ms: number) {
