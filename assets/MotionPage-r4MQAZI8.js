import{j as e,g as n,a as c,C as w,R as Te,f as Re,E as Se,L}from"./index-B3Vc337h.js";import{F as Fe,P as f,S as b,D as F,a as v,H as k}from"./FeaturePage-kJ-jaNNu.js";import{G as Me}from"./PlayerLedControls-BvBplWuy.js";import"./BatteryVisualization-B6wJ3WTh.js";import"./Switch-BI-2z897.js";import{C as j}from"./CodeBlock-C5O9LPzb.js";const X=n.div`
  display: flex;
...
`,be=n.span`
  ...
  color: rgba(191, 204, 214, 0.3);
  flex-shrink: 0;
`;function $(t){const a=t.toFixed(3);return t>=0?` ${a}`:a}const me=({data:t,even:a})=>{const r=t.label.split(".");return e.jsxs(Ae,{$even:a,children:[e.jsxs(fe,{$tip:t.tooltip,children:[e.jsx(be,{children:"i"}),e.jsxs(ue,{children:[e.jsx(H,{children:"controller."}),r.map((s,i)=>e.jsxs(Te.Fragment,{children:[i>0&&e.jsx(H,{children:"."}),i===r.length-1?s:e.jsx(H,{children:s})]},i))]})]}),e.jsx(Pe,{$highlight:t.highlight,children:t.state}),e.jsx(Ce,{$active:t.active,children:t.active?"true":"false"})]})};function ye(t,a,r){return[{label:`${t}.x.state`,tooltip:r.x,state:$(a.x.state),active:a.x.active,highlight:a.x.state!==0},{label:`${t}.x.force`,tooltip:`${r.force} X axis. Returns 0 inside the axis deadzone.`,state:$(a.x.force),active:a.x.active,highlight:a.x.force!==0},{label:`${t}.y.state`,tooltip:r.y,state:$(a.y.state),active:a.y.active,highlight:a.y.state!==0},{label:`${t}.y.force`,tooltip:`${r.force} Y axis. Returns 0 inside the axis deadzone.`,state:$(a.y.force),active:a.y.active,highlight:a.y.force!==0},{label:`${t}.z.state`,tooltip:r.z,state:$(a.z.state),active:a.z.active,highlight:a.z.state!==0},{label:`${t}.z.force`,tooltip:`${r.force} Z axis. Returns 0 inside the axis deadzone.`,state:$(a.z.force),active:a.z.active,highlight:a.z.force!==0}]}const De=()=>{const a=c.useContext(w).gyroscope,[,r]=c.useState(0);c.useEffect(()=>{const i=()=>r(o=>o+1);return a.on("change",i),()=>{a.removeListener("change",i)}},[a]);const s=ye("gyroscope",a,{x:"Raw angular velocity around the X axis (pitch). -1 to 1.",y:"Raw angular velocity around the Y axis (yaw). -1 to 1.",z:"Raw angular velocity around the Z axis (roll). -1 to 1.",force:"Deadzone-applied angular velocity on the"});return e.jsx(e.Fragment,{children:s.map((i,o)=>e.jsx(me,{data:i,even:o%2===1},i.label))})},qe=()=>{const a=c.useContext(w).accelerometer,[,r]=c.useState(0);c.useEffect(()=>{const i=()=>r(o=>o+1);return a.on("change",i),()=>{a.removeListener("change",i)}},[a]);const s=ye("accelerometer",a,{x:"Linear acceleration on the X axis (lateral). ~0.25 = 1g, 1.0 = 4g. Not yet normalized to standard units.",y:"Linear acceleration on the Y axis (vertical). Includes gravity (~0.25 at rest). ~0.25 = 1g, 1.0 = 4g.",z:"Linear acceleration on the Z axis (forward/back). ~0.25 = 1g, 1.0 = 4g. Not yet normalized to standard units.",force:"Deadzone-applied linear acceleration on the"});return e.jsx(e.Fragment,{children:s.map((i,o)=>e.jsx(me,{data:i,even:o%2===1},i.label))})},je=()=>e.jsxs(pe,{children:[e.jsx("div",{style:{width:15,flexShrink:0}}),e.jsx(D,{style:{flex:1},children:"property"}),e.jsx(D,{style:{flexShrink:0,width:"7ch",textAlign:"right"},children:"value"}),e.jsx(D,{style:{flexShrink:0,width:"5ch"},children:"active"})]}),We=()=>e.jsxs(X,{children:[e.jsx(je,{}),e.jsx(De,{})]}),He=()=>e.jsxs(X,{children:[e.jsx(je,{}),e.jsx(qe,{})]}),Le=n.div`
  display: flex;
  align-items: center;
  gap: 14px;
  padding: 10px 16px;
...
`,Ie=n.code`
  ...
  color: ${t=>t.$highlight?"#f29e02":"rgba(191, 204, 214, 0.5)"};
  transition: color 0.06s;
`,Be=()=>{const t=c.useContext(w),[,a]=c.useState(0);c.useEffect(()=>{const i=()=>a(o=>o+1);return t.gyroscope.on("change",i),()=>{t.gyroscope.removeListener("change",i)}},[t]);const r=t.sensorTimestamp??0,s=r>0;return e.jsxs(Le,{children:[e.jsxs(fe,{$tip:"Monotonic hardware clock in microseconds. Wraps at 2³² (~71.6 min). Use for precise motion integration.",children:[e.jsx(be,{children:"i"}),e.jsxs(ue,{children:[e.jsx(H,{children:"controller."}),"sensorTimestamp"]})]}),e.jsxs(Ie,{$highlight:s,children:[r.toLocaleString()," ",e.jsx("span",{style:{fontSize:11,color:"rgba(191,204,214,0.3)"},children:"µs"})]})]})},Ee=()=>e.jsxs(X,{children:[e.jsxs(pe,{children:[e.jsx("div",{style:{width:15,flexShrink:0}}),e.jsx(D,{style:{flex:1},children:"property"}),e.jsx(D,{style:{flexShrink:0,textAlign:"right"},children:"value"})]}),e.jsx(Be,{})]}),G=n.div`
  display: flex;
  flex-wrap: wrap;
  gap: 16px;
  width: 100%;
...
`,_e=n.div`
  ...
  border-radius: 8px;
  width: 100%;
`;function Ne(t){const a=t.toFixed(1);return t>=0?`+${a}`:a}function Ze(t){return t.toFixed(20).replace(/0+$/,"0")}const we=1/32767,Qe=n.div`
  padding: 6px 16px;
...
`,U=({title:t,rows:a})=>e.jsxs(Xe,{children:[e.jsx(Qe,{children:t}),e.jsxs(Ye,{children:[e.jsx(I,{style:{width:"9ch",flexShrink:0},children:"axis"}),e.jsx(I,{style:{flexShrink:0,width:"7ch",textAlign:"right"},children:"bias"}),e.jsx(I,{style:{flex:1,textAlign:"right"},children:"scale"})]}),a.map((r,s)=>e.jsxs(Ve,{$even:s%2===1,children:[e.jsx(Ge,{children:r.label}),e.jsx(Ue,{$highlight:r.bias!==0,children:Ne(r.bias)}),e.jsx(Oe,{$highlight:r.scale!==we,children:Ze(r.scale)})]},r.label))]}),Je=()=>{const t=c.useContext(w),[,a]=c.useState(0);c.useEffect(()=>{const i=()=>a(d=>d+1);t.connection.on("change",i);const o=setTimeout(i,1e3);return()=>{t.connection.removeListener("change",i),clearTimeout(o)}},[t]);const r=t.calibration;return r.gyroPitch.scale===we&&r.gyroPitch.bias===0&&r.accelX.bias===0&&!t.connection.state?e.jsx(G,{children:e.jsx(_e,{children:"Connect a controller to view its factory calibration"})}):e.jsxs(G,{children:[e.jsx(U,{title:"Gyroscope",rows:[{label:"Pitch (X)",bias:r.gyroPitch.bias,scale:r.gyroPitch.scale},{label:"Yaw (Y)",bias:r.gyroYaw.bias,scale:r.gyroYaw.scale},{label:"Roll (Z)",bias:r.gyroRoll.bias,scale:r.gyroRoll.scale}]}),e.jsx(U,{title:"Accelerometer",rows:[{label:"X",bias:r.accelX.bias,scale:r.accelX.scale},{label:"Y",bias:r.accelY.bias,scale:r.accelY.scale},{label:"Z",bias:r.accelZ.bias,scale:r.accelZ.scale}]})]})},O=n.div`
  display: flex;
  flex-wrap: wrap;
  gap: 16px;
  width: 100%;
...
`,it=n.svg`
  display: block;
`,nt=({pitch:t,roll:a,size:r=120})=>{const s=r/2,i=r/2,o=r/2-4,d=Math.max(-o,Math.min(o,t/(Math.PI/2)*o)),u=a*180/Math.PI;return e.jsxs(it,{width:r,height:r,viewBox:`0 0 ${r} ${r}`,children:[e.jsx("defs",{children:e.jsx("clipPath",{id:"horizon-clip",children:e.jsx("circle",{cx:s,cy:i,r:o})})}),e.jsx("circle",{cx:s,cy:i,r:o,fill:"rgba(0, 0, 0, 0.3)",stroke:"rgba(255,255,255,0.08)",strokeWidth:1}),e.jsxs("g",{clipPath:"url(#horizon-clip)",transform:`rotate(${u}, ${s}, ${i})`,children:[e.jsx("rect",{x:0,y:0,width:r,height:i+d,fill:"rgba(72, 175, 240, 0.12)"}),e.jsx("rect",{x:0,y:i+d,width:r,height:r,fill:"rgba(139, 90, 43, 0.15)"}),e.jsx("line",{x1:0,y1:i+d,x2:r,y2:i+d,stroke:"rgba(255, 255, 255, 0.3)",strokeWidth:1.5}),[-30,-15,15,30].map(g=>{const p=g/90*o;return e.jsx("line",{x1:s-o*.3,y1:i+d+p,x2:s+o*.3,y2:i+d+p,stroke:"rgba(255, 255, 255, 0.1)",strokeWidth:.5},g)})]}),e.jsx("line",{x1:s-20,y1:i,x2:s-6,y2:i,stroke:"#f29e02",strokeWidth:2,strokeLinecap:"round"}),e.jsx("line",{x1:s+6,y1:i,x2:s+20,y2:i,stroke:"#f29e02",strokeWidth:2,strokeLinecap:"round"}),e.jsx("circle",{cx:s,cy:i,r:2,fill:"#f29e02"}),e.jsx("circle",{cx:s,cy:i,r:o,fill:"none",stroke:"rgba(255,255,255,0.12)",strokeWidth:1.5})]})};function K(t){const a=t.toFixed(3);return t>=0?`+${a}`:a}function ee(t){const a=t*180/Math.PI,r=Math.abs(a).toFixed(1);return a>=0?`+${r}°`:`-${r}°`}function ot(t){return t.toFixed(4)}const at=()=>{const t=c.useContext(w),[,a]=c.useState(0),r=c.useRef(0);c.useEffect(()=>{const x=()=>{a(h=>h+1),r.current=requestAnimationFrame(x)};return r.current=requestAnimationFrame(x),()=>cancelAnimationFrame(r.current)},[t]);const s=c.useCallback(()=>{t.orientation.reset()},[t]),i=t.orientation;if(!t.connection.state)return e.jsx(O,{children:e.jsx(et,{children:"Connect a controller to view live orientation"})});const[d,u,g,p]=i.quaternion,R=Math.abs(i.pitch)>.01||Math.abs(i.yaw)>.01||Math.abs(i.roll)>.01;return e.jsxs(O,{children:[e.jsxs(B,{children:[e.jsxs(E,{children:[e.jsx("span",{children:"Euler Angles"}),e.jsx(Ke,{onClick:s,children:"Reset"})]}),e.jsxs(_,{children:[e.jsx(z,{style:{width:"5ch",flexShrink:0},children:"axis"}),e.jsx(z,{style:{flex:1,textAlign:"right"},children:"radians"}),e.jsx(z,{style:{flexShrink:0,width:"7ch",textAlign:"right"},children:"degrees"})]}),[["Pitch",i.pitch],["Yaw",i.yaw],["Roll",i.roll]].map(([x,h],m)=>e.jsxs(N,{$even:m%2===1,children:[e.jsx(Z,{children:x}),e.jsx(Q,{$highlight:Math.abs(h)>.01,children:K(h)}),e.jsx(J,{$highlight:Math.abs(h)>.01,children:ee(h)})]},x))]}),e.jsxs(B,{children:[e.jsx(E,{children:e.jsx("span",{children:"Accelerometer Tilt"})}),e.jsxs(_,{children:[e.jsx(z,{style:{width:"5ch",flexShrink:0},children:"axis"}),e.jsx(z,{style:{flex:1,textAlign:"right"},children:"radians"}),e.jsx(z,{style:{flexShrink:0,width:"7ch",textAlign:"right"},children:"degrees"})]}),[["Pitch",i.tiltPitch],["Roll",i.tiltRoll]].map(([x,h],m)=>e.jsxs(N,{$even:m%2===1,children:[e.jsx(Z,{children:x}),e.jsx(Q,{$highlight:Math.abs(h)>.05,children:K(h)}),e.jsx(J,{$highlight:Math.abs(h)>.05,children:ee(h)})]},x))]}),e.jsxs(B,{style:{flex:"1 1 200px"},children:[e.jsx(E,{children:e.jsx("span",{children:"Quaternion"})}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12,padding:"10px 16px",background:"rgba(0, 0, 0, 0.06)"},children:[e.jsx(nt,{pitch:i.pitch,roll:i.roll,size:100}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:4},children:[["w",d],["x",u],["y",g],["z",p]].map(([x,h])=>e.jsxs("div",{style:{display:"flex",gap:6,alignItems:"center"},children:[e.jsx(tt,{children:x}),e.jsx(rt,{$highlight:R&&x!=="w",children:ot(h)})]},x))})]})]})]})},te=n.div`
  display: flex;
  flex-wrap: wrap;
  gap: 16px;
  width: 100%;
...
`,dt=n.svg`
  display: block;
`,ht=({pitch:t,roll:a,size:r=120})=>{const s=r/2,i=r/2,o=r/2-4,d=o*.7,u=s+Math.max(-d,Math.min(d,-(a/(Math.PI/4))*d)),g=i+Math.max(-d,Math.min(d,t/(Math.PI/4)*d)),p=Math.sqrt((u-s)**2+(g-i)**2)/d,R=p<.15?"rgba(72, 175, 240, 0.8)":`rgba(242, 158, 2, ${.4+p*.5})`;return e.jsxs(dt,{width:r,height:r,viewBox:`0 0 ${r} ${r}`,children:[e.jsx("circle",{cx:s,cy:i,r:o,fill:"rgba(0, 0, 0, 0.3)",stroke:"rgba(255,255,255,0.08)",strokeWidth:1}),e.jsx("line",{x1:s,y1:i-o*.5,x2:s,y2:i+o*.5,stroke:"rgba(255,255,255,0.06)",strokeWidth:.5}),e.jsx("line",{x1:s-o*.5,y1:i,x2:s+o*.5,y2:i,stroke:"rgba(255,255,255,0.06)",strokeWidth:.5}),e.jsx("circle",{cx:s,cy:i,r:o*.15,fill:"none",stroke:"rgba(255,255,255,0.08)",strokeWidth:.5}),e.jsx("circle",{cx:s,cy:i,r:o*.4,fill:"none",stroke:"rgba(255,255,255,0.05)",strokeWidth:.5}),e.jsx("circle",{cx:u,cy:g,r:8,fill:R}),e.jsx("circle",{cx:u,cy:g,r:8,fill:"none",stroke:"rgba(255,255,255,0.2)",strokeWidth:.5}),e.jsx("circle",{cx:s,cy:i,r:o,fill:"none",stroke:"rgba(255,255,255,0.12)",strokeWidth:1.5})]})};function se(t){const a=t.toFixed(3);return t>=0?`+${a}`:a}function ce(t){const a=t*180/Math.PI,r=Math.abs(a).toFixed(1);return a>=0?`+${r}°`:`-${r}°`}const xt=()=>{const t=c.useContext(w),[,a]=c.useState(0),r=c.useRef(0);if(c.useEffect(()=>{const u=()=>{a(g=>g+1),r.current=requestAnimationFrame(u)};return r.current=requestAnimationFrame(u),()=>cancelAnimationFrame(r.current)},[t]),!t.connection.state)return e.jsx(te,{children:e.jsx(lt,{children:"Connect a controller to view live tilt"})});const i=t.orientation,o=Math.abs(i.tiltPitch)>.05,d=Math.abs(i.tiltRoll)>.05;return e.jsxs(te,{children:[e.jsxs(st,{children:[e.jsx(ct,{children:"Tilt Angles"}),e.jsxs(re,{children:[e.jsxs(ie,{children:[e.jsx(ne,{children:"orientation."}),"tiltPitch"]}),e.jsx(oe,{$highlight:o,children:se(i.tiltPitch)}),e.jsx(ae,{$highlight:o,children:ce(i.tiltPitch)})]}),e.jsxs(re,{$even:!0,children:[e.jsxs(ie,{children:[e.jsx(ne,{children:"orientation."}),"tiltRoll"]}),e.jsx(oe,{$highlight:d,children:se(i.tiltRoll)}),e.jsx(ae,{$highlight:d,children:ce(i.tiltRoll)})]})]}),e.jsxs("div",{style:{flex:"0 0 auto",display:"flex",flexDirection:"column",alignItems:"center",gap:8},children:[e.jsx(ht,{pitch:i.tiltPitch,roll:i.tiltRoll,size:120}),e.jsx("div",{style:{fontSize:10,textTransform:"uppercase",letterSpacing:"0.08em",color:"rgba(191, 204, 214, 0.3)"},children:"Bubble level"})]})]})},le=n.div`
  display: flex;
  flex-wrap: wrap;
  gap: 16px;
  width: 100%;
...
});`}),e.jsx(k,{children:"The sensor timestamp comes from the controller's own clock, not the host, so it is unaffected by system load and transport jitter. It reflects exactly when the IMU sampled."}),e.jsx(b,{children:"Orientation Tracking"}),e.jsxs(f,{children:[e.jsx("p",{children:"The library includes a built-in Madgwick AHRS (Attitude and Heading Reference System) filter that fuses gyroscope and accelerometer data into a stable orientation estimate. It runs automatically on every HID report, using the controller's hardware timestamp for precise integration."}),e.jsxs("p",{children:["The filter outputs Euler angles (pitch, yaw, roll in radians) and the underlying unit quaternion. It uses gradient descent to correct gyroscope drift against the accelerometer's gravity reference, controlled by a configurable ",e.jsx("code",{children:"beta"})," gain parameter."]})]}),e.jsx(F,{children:"Rotate your controller to see orientation change"}),e.jsx(v,{style:{padding:0,border:"none",background:"none",minHeight:0},children:e.jsx(at,{})}),e.jsx(j,{code:`// Read fused orientation in a game loop
...
controller.orientation.beta = 0.3;  // snappier, more noise`}),e.jsxs(k,{children:["The Madgwick filter cannot determine absolute yaw (compass heading) from accelerometer data alone - the accelerometer only provides a gravity reference for pitch and roll correction. Yaw is integrated from the gyroscope and will drift slowly over time. Call"," ",e.jsx("code",{children:"controller.orientation.reset()"})," to re-zero when needed."]}),e.jsx(b,{children:"Accelerometer Tilt"}),e.jsx(f,{children:e.jsx("p",{children:"For applications that only need pitch and roll relative to gravity (steering wheels, balance games, level tools), the orientation tracker also exposes accelerometer-only tilt angles. These derive directly from the gravity vector without gyroscope integration, so they never drift. The tradeoff is they're noisy during fast motion and cannot measure yaw."})}),e.jsx(F,{children:"Tilt your controller to see the bubble move"}),e.jsx(v,{style:{padding:0,border:"none",background:"none",minHeight:0},children:e.jsx(xt,{})}),e.jsx(j,{code:`// Tilt-based steering (no drift, no yaw)
