import{u as w,a as x,j as e,m,r as b,g as t,d as v,L as k}from"./index-B3Vc337h.js";import{F as C,P as i,D as $,S as c,H as D}from"./FeaturePage-kJ-jaNNu.js";import{B as P}from"./Switch-BI-2z897.js";import{C as l}from"./CodeBlock-C5O9LPzb.js";const I=t.div`
...
`,E={"00":"#e8e8e8","01":"#1a1a2e","02":"#c8102e","03":"#f2a6c0","04":"#6b3fa0","05":"#5b9bd5","06":"#8a9a7b","07":"#9b2335","08":"#c0c0c0","09":"#1e3a5f",10:"#2db5a0",11:"#3d4f7c",12:"#e8dfd0",30:"#4a4a4a"},R=t.div`
  display: flex;
  align-items: center;
  gap: 8px;
  min-width: 0;
...
`;function j(n,p){const g=n.connection.state,a=n.factoryInfo,r=n.battery.level.state,o=n.battery.status.state;return{index:p,connected:g,wireless:g?n.wireless:!1,colorCode:a.colorCode,colorName:a.colorName!=="unknown"?a.colorName:"Unknown",batteryPct:Math.round(r*100),charging:o===v.ChargeStatus.Charging||o===v.ChargeStatus.Full,serial:a.serialNumber!=="unknown"?a.serialNumber:"—"}}const _=()=>{const{controllers:n}=w(),[p,g]=x.useState([]),a=x.useRef(n);return a.current=n,x.useEffect(()=>{const r=()=>{const s=a.current;g(s.map((d,u)=>j(d,u)))};r();const o=setInterval(r,500);return()=>clearInterval(o)},[n.length]),x.useEffect(()=>{const r=[];return n.forEach(o=>{const s=()=>{g(d=>d.map((u,f)=>n[f]===o?j(o,f):u))};o.on("change",s),o.connection.on("change",s),r.push(()=>{o.removeListener("change",s),o.connection.removeListener("change",s)})}),()=>r.forEach(o=>o())},[n]),e.jsxs(I,{children:[e.jsxs(B,{children:[e.jsx(h,{children:"#"}),e.jsx(h,{children:"controller"}),e.jsx(h,{children:"transport"}),e.jsx(h,{children:"battery"}),e.jsx(h,{children:"serial"}),e.jsx(h,{})]}),p.length===0?e.jsx(S,{children:m?e.jsxs(e.Fragment,{children:["No controllers connected."," ",e.jsx(P,{$small:!0,onClick:b,style:{marginLeft:8},children:"Connect"})]}):"WebHID not available in this browser."}):p.map((r,o)=>{const s=E[r.colorCode];return e.jsxs(L,{$even:o%2===1,$connected:r.connected,children:[e.jsx(M,{$connected:r.connected,children:r.index+1}),e.jsxs(R,{children:[s&&e.jsx(N,{$color:s}),e.jsx(z,{children:r.colorName})]}),e.jsxs(T,{children:[r.wireless?e.jsx(y,{width:"14",height:"14",viewBox:"0 0 24 24",children:e.jsx("path",{d:"M17.71 7.71 12 2h-1v7.59L6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 11 14.41V22h1l5.71-5.71-4.3-4.29 4.3-4.29zM13 5.83l1.88 1.88L13 9.59V5.83zm1.88 10.46L13 18.17v-3.76l1.88 1.88z"})}):e.jsx(y,{width:"14",height:"14",viewBox:"0 0 24 24",children:e.jsx("path",{d:"M15 7v4h1v2h-3V5h2l-3-4-3 4h2v8H8v-2.07A1.993 1.993 0 0 0 8 7a2 2 0 0 0-4 0c0 .74.4 1.38 1 1.73V13a2 2 0 0 0 2 2h3v2.27c-.6.35-1 .99-1 1.73a2 2 0 0 0 4 0c0-.74-.4-1.38-1-1.73V15h3a2 2 0 0 0 2-2v-2h1V7h-3z"})}),e.jsx(A,{children:r.connected?r.wireless?"BT":"USB":"—"})]}),e.jsxs(H,{children:[e.jsx(q,{children:e.jsx(F,{$pct:r.connected?r.batteryPct:0,$charging:r.charging})}),e.jsx(U,{children:r.connected?`${r.batteryPct}%`:"—"})]}),e.jsx(V,{children:(r.connected,r.serial)}),e.jsx(W,{title:"Release slot",onClick:()=>{var d;return(d=m)==null?void 0:d.release(r.index)},children:"✕"})]},o)}),m&&e.jsxs(O,{onClick:b,children:[e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"})}),"Connect Controller"]})]})},Q=()=>e.jsxs(C,{title:"Multiplayer",subtitle:"Manage multiple controllers with automatic discovery, identity-based reconnection, and player LED assignment.",children:[e.jsx(i,{children:e.jsxs("p",{children:["The ",e.jsx("strong",{children:"DualsenseManager"})," class handles multi-controller scenarios. It discovers controllers automatically, assigns player LED patterns, and tracks hardware identity so a reconnecting controller returns to its original slot. Managed controllers are exposed through a stable slot system."]})}),e.jsx($,{children:"Connect or disconnect controllers to see live slot updates"}),e.jsx(_,{}),e.jsx(c,{children:"Setting Up the Manager"}),e.jsx(i,{children:e.jsxs("p",{children:["Create a manager instance to start discovering controllers. In the browser, WebHID requires a"," ",e.jsx("a",{href:"https://developer.mozilla.org/en-US/docs/Web/API/User_activation",target:"_blank",rel:"noopener noreferrer",children:"user gesture"})," ","to open the device picker - the manager provides a"," ",e.jsx("code",{children:"getRequest()"})," helper for this. In Node.js, controllers are discovered automatically via USB enumeration."]})}),e.jsx(l,{code:`import { DualsenseManager } from "dualsense-ts";
...
manager.getPlayerPattern(0);       // 0x1f`}),e.jsx(c,{children:"Slot Management"}),e.jsx(i,{children:e.jsx("p",{children:"Release slots to free them for reuse. Releasing a slot disconnects the controller (if still connected), removes identity mappings, and re-indexes the remaining slots, updating their player LED assignments to match."})}),e.jsx(l,{code:`// Release a specific slot
manager.release(0);
